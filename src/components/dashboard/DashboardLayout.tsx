            ...
            <nav className="bg-white border-b border-gray-200 fixed top-0 left-0 right-0 z-50">
                <div className="px-4 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {/* Logo */}
                        <Logo withText={true} to="/" className="hidden sm:flex" />
                        <Logo withText={false} to="/" className="sm:hidden" />
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative">
                            ...
                            >
                                <div className="w-8 h-8 bg-[#000435] rounded-full flex items-center justify-center">
                                    <User size={16} className="text-white" />
                                </div>
                                <span className="hidden sm:block text-sm font-medium text-gray-700">Ma Boutique</span>
